    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <center><label for="tgl_akhir">Tanggal Akhir</label></center>
                <div class="form-group">
                    <input type="date" class="form-control" id="tgl_akhir" placeholder="Pilih Tanggal Akhir">
                </div>
                <div class="form-group">
                    <a href=""
                        onclick="this.href='/mitra/tagihan/cetak/'+document.getElementById('tgl_awal').value+'/'+document.getElementById('tgl_akhir').value"
