            ...
            <div class="card-body">
                ...
                <form id="save">
                    @if (auth()->guard('admin')->check())
                        ...
                        <div style="text-align: center; line-height: 1.5;">{{ $mitra->nama }}</div>
                        <div style="text-align: center; line-height: 1.5;">&nbsp;</div>
                        <div style="line-height: 1.5; text-align: justify;">Pada Hari ini <strong>{{ $day }}</strong>, tanggal <strong>{{ $tanggal }}</strong> bulan<strong> {{ $bulan }}</strong> tahun <strong>{{ $tahun }} </strong>bertempat di Blitar, PARA PIHAK yang&nbsp;bertanda tangan dibawah ini :</div>
                        ...
                        <li style="text-align: justify; line-height: 1.5;"><strong>{{ $mitra->nama }}</strong> dalam hal ini bertindak untuk dan atas nama {{ $mitra->nama }}, yang berkedudukan di {{ $mitra->alamat }}, pribadi untuk selanjutnya disebut sebagai <strong>PIHAK KEDUA</strong>.</li>
                        </ol>
                        </div>
                ...
                <div id="container">
                    ...
                    <div style="text-align: center; line-height: 1.5;">&nbsp;</div>
                    <div style="line-height: 1.5; text-align: justify;">Pada Hari ini <strong>{{ $day }}</strong>,
                        tanggal <strong>{{ $tanggal }}</strong> bulan<strong> {{ $bulan }}</strong> tahun
                        <strong>{{ $tahun }} </strong>bertempat di Blitar, PARA PIHAK yang&nbsp;bertanda tangan
                        dibawah ini :</div>
                    <div style="line-height: 1.5;">
                        <ol style="text-align: justify;">
                            ...
                            <li style="text-align: justify; line-height: 1.5;"><strong>{{ $po->nama }}</strong> dalam
                                hal ini bertindak untuk dan atas nama {{ $po->nama }}, yang berkedudukan di
                                {{ $po->alamat }}, pribadi untuk selanjutnya disebut sebagai <strong>PIHAK
                                    KEDUA</strong>.</li>
                        </ol>
                    </div>
