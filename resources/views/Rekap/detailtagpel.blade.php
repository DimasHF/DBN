    ...
    <div class="row justify-content-center">
        <div id="print_out" class="col-md-6 stretch-card grid-margin ">
            <div class="card ">
                <div class="card-body">
                    <p>
                        <center><b>{{ $tagihan->id_tagihan }}</b></center>
                    </p><br>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <table class="col-md-12" border="1px">
                                ...
                                <tbody>
                                    @foreach ($detaillayanan as $r)
                                        <tr>
                                            ...
                                            <td>
                                                <center>Rp. {{ number_format($r->pajak, 0, ',', '.') }}</center>
                                            </td>
                                            <td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <center>Rp. {{ number_format($tagihan->bayar, 0, ',', '.') }}</center>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                        ...
                                        <td>
                                            <center>Rp. {{ number_format($tagihan->sisa, 0, ',', '.') }}</center>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
