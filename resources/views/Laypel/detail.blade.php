            ...
            <div class="card ">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <p>Nama Pelanggan : {{ $detailpelanggan->nama }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <table class="col-md-12" border="1px">
                                ...
                                <tbody>
                                    @foreach ($detaillayanan as $r)
                                        <tr>
                                            ...
                                            <td>
                                                <center>{{ number_format($r->harga, 0, ',', '.') }}</center>
                                            </td>
                                            <td>
                                                <center>{{ number_format($r->biaya, 0, ',', '.') }}</center>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <center>{{ number_format($detail->total, 0, ',', '.') }}</center>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
